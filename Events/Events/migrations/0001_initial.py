...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Events_details', (
            ...
            ('place', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True)),
        ))
        ...
        db.create_table(u'Events_cities', (
            ...
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Events.Details'])),
        ))
    ...
    models = {
        u'Events.cities': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Events.Details']"}),
        ...
        u'Events.details': {
            ...
            'place': ('django.db.models.fields.CharField', [], {'max_length': '30', 'primary_key': 'True'})
        }
    }
